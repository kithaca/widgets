	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        this.props.tabs.map(function (tab) {
	          return React.createElement(
	            'li',
	            { key: tab.id, onClick: tabs.tabClick.bind(tabs, tab.id) },
	            tab.title
	          );
	        })
	      ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
	  ...
	  queryOpenWeather: function () {
	    ...
	    request.open('GET', 'http://api.openweathermap.org/data/2.5/weather?lat=' + this.state.currentLat + '&lon=' + this.state.currentLon + '&APPID=645c5d39c7603f17e23fcaffcea1a3c1', true);
